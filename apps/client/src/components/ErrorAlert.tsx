...
export default function ErrorAlert({ className, message, onClose }: ErrorAlertProps) {
  return (
    <div className={`${className} relative w-full bg-red-700 border border-red-900 text-red-100 px-4 py-3 rounded relative"`} role="alert">
